...
```
Filerne deler et globalt miljø i R, så nogle bruger objekter fra en tidligere fil. Kør i samme session i denne rækkefølge, hvis man ønsker at genskabe projektets resultater:

1. t-fordelinger, teststørrelser og teststyrker (Afsnit 4)
2. Genskabte Acerbi plots — kræver 
3. Heatmaps og styrkeplots (Afsnit 4) 
4. VaR vs. ES plot — kræver 
...
Fuld kørsel tager flere timer. Sænk M for en hurtigere test, dette vil dog påvirke resultaterne.
